...
###什么是语义化标签：
    ...
    下图没有语义化标签：
![](E:/BaiduNetdisk/Download/images/没有语义.png)
###添加语义标签：
![](E:/BaiduNetdisk/Download/images/语义化.png)
###常用的标签：
###标题标签
    **标题标签 <h1> - <h6>（重要)**
...
​        
    ...
    ###文本格式化标签：
        ...
        ![](E:/BaiduNetdisk/Download/images/格式化标签.png)
        ###div和span标签
...
###图片标签：
    ...
    图像标签的其他属性：
![](E:/BaiduNetdisk/Download/images/图片属性.png) 
​    
    图像标签注意点：
...
![](E:/BaiduNetdisk/Download/images/路径.png) 
    特点：
...
+        找到目标位置标签，里面添加一个 id 属性 = 刚才的名字 ，如：<h3 id="two">第2集介绍</h3>
         ...
         ![](E:/BaiduNetdisk/Download/images/特殊字符.png) 
